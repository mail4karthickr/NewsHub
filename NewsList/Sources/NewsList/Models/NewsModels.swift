...
public enum DateFilter: CaseIterable, Identifiable, Sendable {
    case all
    case today
    case lastWeek
    case lastMonth
    ...
    public static var allCases: [DateFilter] {
    ...
    public func isEqual(to other: DateFilter) -> Bool {
        switch (self, other) {
...
public struct NewsSource: Codable, Identifiable, Equatable, Sendable {
    public let id: String
    public let name: String
    public let description: String?
    public let url: String?
